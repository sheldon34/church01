package com.example.tryapp2.R2Config;
...
String contentType= Optional.ofNullable(file.getContentType())
        . orElseThrow(()->new UnsupportedMediaTypeException("File  not found"));
...
String folder=switch(ext){
    ...
    default ->  throw new UnsupportedMediaTypeException("File  not found");
};
